...
<nav class="navbar navbar-light bg-light">
  ...
  <li>
    ...
    <li>
      ...
      <ul>
        <li>
          <input class="one-nested-input" type="radio" @click="FunctionNumeroIntern(false)" value="Sans objet" v-model="form.NumeroInterne.description">
          Sans objet
        </li>
        <li>
          <input class="one-nested-input" type="radio"  @click="FunctionNumeroIntern(true)" v-model="form.NumeroInterne.description">
          N°: 
          <input class="input" type="text" v-if="FlagNumeroIntern" v-model="form.NumeroInterne.autre">
        </li>
      </ul>
    ...
    <li>Type d’appareil
      <ul>
        <li>
          <input class="one-nested-input" type="radio"  value="Elévateur Gerbeur a conducteur porté" v-model="form.TypeAppareil.description"  @click="FunctionTypeAppareil(false)" checked>
          Elévateur Gerbeur a conducteur porté
        </li>
        <li>
          <input class="one-nested-input" type="radio" value="Elévateur Gerbeur a conducteur accompagnant" v-model="form.TypeAppareil.description" @click="FunctionTypeAppareil(false)">
          Elévateur Gerbeur a conducteur accompagnant
        </li>
        <li>
          <input class="one-nested-input" type="radio" value="Elévateur gerbeur tout terrain" v-model="form.TypeAppareil.description" @click="FunctionTypeAppareil(false)">
          Elévateur gerbeur tout terrain
        </li>
        <li>
          <input class="one-nested-input" type="radio" value="De manutention automoteur à conducteur porté (porteur, tracteur, pousseur)" v-model="form.TypeAppareil.description" @click="FunctionTypeAppareil(false)">
          De manutention automoteur à conducteur porté (porteur, tracteur, pousseur 
        </li>
        <li>
          <input class="one-nested-input" type="radio" value="false" @click="FunctionTypeAppareil(true)" v-model="form.TypeAppareil.description">
          Autre :
          <input class="input" type="text"  v-if="FlagTypeAppareil" v-model="form.TypeAppareil.autre">
        </li>
      </ul>
    </li>
